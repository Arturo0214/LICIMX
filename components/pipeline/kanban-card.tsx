...
export function KanbanCard({ bid, assignedUserName }: KanbanCardProps) {
  ...
  return (
    <Link href={`/licitaciones/${bid.id}`}>
      <div
        className={cn(
          "group cursor-pointer rounded-lg border border-border/60 bg-card p-3.5 transition-all duration-150",
